    ...
    public class ParticipationController : ControllerBase
    {
        ...
        public async Task<IActionResult> Confirm(int id)
        {
            ...
            if (participation.IdStatusParticipation == 2) // 2 = 'Confirmed'
                return BadRequest("Участие уже было подтверждено ранее."); double? calculatedPoints = participation.IdEventNavigation.BasePoints * participation.IdEventNavigation.ComplexityCoeff;
